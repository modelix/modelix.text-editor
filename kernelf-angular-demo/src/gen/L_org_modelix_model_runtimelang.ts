...
this.nodeWrappers.set("mps:b6980ebd-f01d-459d-a952-38740f6313b4/7113393488488348865", (node: INodeJS) => new BranchInfo(node))
            ...
            export const INSTANCE = L_org_modelix_model_runtimelang.INSTANCE
                ...
                public repositories: ChildListAccessor<L_org_modelix_model_runtimelang.RepositoryInfo> = new ChildListAccessor(this.node, "repositories")
                ...
                // super concept: jetbrains.mps.lang.core.BaseConcept 
                        ...
                        export class RepositoryInfo extends TypedNode {
                            ...
                            public branches: ChildListAccessor<L_org_modelix_model_runtimelang.BranchInfo> = new ChildListAccessor(this.node, "branches")
                            // feature: id 
            // feature: branches 
                            // super concept: jetbrains.mps.lang.core.BaseConcept 
                        }
