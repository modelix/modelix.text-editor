...
export class ExplorerComponent implements OnInit {
  ...
  public getModules(): Array<L_org_modelix_model_repositoryconcepts.N_Module> {
    if (this.node === undefined) return []
    let modules: Array<any /* INode */> = org.modelix.editor.kernelf.KernelfAPI.getModules(this.node);
    return modules.map(n => LanguageRegistry.INSTANCE.wrapNode(org.modelix.model.api.JSNodeConverter.nodeToJs(n)) as L_org_modelix_model_repositoryconcepts.N_Module)
  }
}
