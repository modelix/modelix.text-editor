...
export class CCMenu {
    ...
    processKeyUp(_: KeyboardEvent): boolean {
        return false;
    }
    ...
    protected hideMouseHandler: (e: MouseEvent) => void = (_: MouseEvent) => {
        this.setVisible(false);
    }
...
export class ListBox {
    ...
    updateVisibleSelection(): void {
        ...
        if (this.visibleSelection !== undefined) {
            this.visibleSelection.classList.remove(styles.visibleSelection);
        }
        if (elementToSelect !== undefined) {
            elementToSelect.classList.add(styles.visibleSelection);
        }
    ...
    renderAction(action: IAction): HTMLElement {
        ...
        matchingTextDom.classList.add(styles.matchingText);
        ...
        descriptionDom.classList.add(styles.description);
        ...
        dom.onmousedown = (_) => this.ccmenu.executeAction(action);
