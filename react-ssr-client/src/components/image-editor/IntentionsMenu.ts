...
export class IntentionsMenu {
    ...
    constructor() {
        ...
        this.dom.classList.add(styles.intentionsMenu);
        this.dom.tabIndex = -1;
        this.dom.onblur = () => {
        ...
        this.entriesContainer.classList.add(styles.entries);
    ...
    loadIntentions(intentions: IIntention[]): void {
        this.entries = [];
        Array.from(this.entriesContainer!!.children).forEach(it => it.remove())
...
export class IntentionsMenuEntry {
    ...
    constructor(public readonly index: number, public readonly intention: IIntention) {
        ...
        this.dom = document.createElement("div");
        this.dom.classList.add(styles.entry);
        this.updateDom();
    }
    ...
    updateDom(): void {
        ...
        if (style) {
            style.backgroundColor = this.selected ? "#1055d1" : "";
            style.color = this.selected ? "white" : "";
        }
    }
