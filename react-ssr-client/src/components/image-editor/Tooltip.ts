...
export class Tooltip {
    ...
    constructor() {
        ...
        this.dom.classList.add(styles.tooltip);
        this.dom.onblur = () => {
            this.setVisible(false);
        };

        this.contentContainer = document.createElement("div");
        this.contentContainer.classList.add(styles.tooltipContent);
    ...
    setText(text: string): void {
        if (this.contentContainer) this.contentContainer.innerText = text;
    }
